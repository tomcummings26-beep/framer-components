...
SEOTextBlock.defaultProps = {
    h1: "Rhône Villas & Holiday Homes",
    intro: "Stay among vineyards and rolling hills with our Rhône villas and holiday homes — from Lyon’s gastronomy to the scenic Beaujolais countryside.",
    sections: [
        {
            title: "About the Rhône Region",
            content:
                "The Rhône region is known for fine wines, historic towns, and beautiful landscapes. Perfect for food and wine lovers, it combines the best of French culture and countryside living.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Lyon</strong> – France’s culinary capital, rich in history and charm.<br/><br/>
        <strong>Beaujolais</strong> – Endless vineyards and peaceful rural retreats.<br/><br/>
        <strong>Vienne</strong> – Roman heritage and river views along the Rhône.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Discover Rhône villas with live availability — from wine estate stays to elegant countryside homes.",
        },
    ],
}
