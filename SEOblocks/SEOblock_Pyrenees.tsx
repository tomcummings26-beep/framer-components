...
SEOTextBlock.defaultProps = {
    h1: "Pyrenees Villas & Holiday Homes",
    intro: "Explore France’s dramatic southern mountains with our Pyrenees villas and holiday homes — from alpine chalets to peaceful countryside stays.",
    sections: [
        {
            title: "About the Pyrenees",
            content:
                "Stretching from the Atlantic to the Mediterranean, the Pyrenees offer a landscape of peaks, lakes, and authentic villages — ideal for hiking, skiing, and summer escapes.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Luz-Saint-Sauveur</strong> – Gateway to the national park.<br/><br/>
        <strong>Saint-Lary-Soulan</strong> – Year-round mountain resort.<br/><br/>
        <strong>Foix</strong> – Historic charm and access to scenic valleys.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Find Pyrenees villas with live availability — from rustic chalets to family retreats near hiking trails.",
        },
    ],
}
