...
SEOTextBlock.defaultProps = {
    h1: "Northern France Villas & Holiday Homes",
    intro: "Discover the rich history and scenic beauty of Northern France with our curated villas and holiday homes — from Normandy’s beaches to Champagne’s vineyards.",
    sections: [
        {
            title: "About Northern France",
            content:
                "Northern France blends coastlines, countryside, and culture. Explore charming towns, world-famous gastronomy, and heritage sites close to Paris and Belgium.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Normandy</strong> – Iconic beaches and countryside manors.<br/><br/>
        <strong>Champagne</strong> – Vineyards and grand châteaux.<br/><br/>
        <strong>Picardy</strong> – Peaceful landscapes and gothic cathedrals.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Browse Northern France villas — from seaside cottages to vineyard retreats, all with live availability.",
        },
    ],
}
