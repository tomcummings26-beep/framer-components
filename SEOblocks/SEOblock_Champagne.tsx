...
SEOTextBlock.defaultProps = {
    h1: "Champagne Villas & Holiday Homes",
    intro: "Stay among France’s most celebrated vineyards with our hand-picked villas and holiday homes in Champagne — elegant countryside escapes near Épernay and Reims.",
    sections: [
        {
            title: "About Champagne",
            content:
                "Champagne is synonymous with celebration and French heritage. Rolling vineyards, grand châteaux, and charming villages make this region ideal for a refined countryside retreat.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Reims</strong> – The historic heart of Champagne, with Gothic cathedrals and cellar tours.<br/><br/>
        <strong>Épernay</strong> – The Avenue de Champagne, lined with prestigious houses and tasting rooms.<br/><br/>
        <strong>Troyes</strong> – Timber-framed architecture and boutique shopping.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Explore Champagne villas with live availability — from vineyard châteaux to stylish rural estates, updated daily for 2026 holidays.",
        },
    ],
}
