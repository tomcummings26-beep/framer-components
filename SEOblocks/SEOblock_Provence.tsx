...
// 🌿 Default content — Provence example
SEOTextBlock.defaultProps = {
    h1: "Provence Villas & Holiday Homes",
    intro: "Discover the timeless charm of Provence with our curated collection of villas and holiday homes — from lavender-scented countryside escapes to elegant retreats near the Luberon and Aix-en-Provence.",
    sections: [
        {
            title: "About Provence",
            content:
                "Provence captures the essence of the South of France — sun-drenched landscapes, vineyards, and centuries-old villages. From the rolling hills of the Luberon to the vibrant streets of Avignon, this region offers rustic beauty and effortless sophistication. Enjoy local markets, rosé vineyards, and serene holiday villas surrounded by olive groves and lavender fields.",
        },
        {
            title: "Top Destinations",
            content: `
                <strong>Gordes</strong> – A postcard-perfect hilltop village with panoramic views and traditional stone houses.<br/><br/>
                <strong>Luberon</strong> – Peaceful countryside dotted with vineyards and charming villas, ideal for family stays.<br/><br/>
                <strong>Avignon</strong> – A historic city of culture and art, known for its medieval architecture and summer festivals.<br/><br/>
                <strong>Aix-en-Provence</strong> – Sophisticated yet relaxed, with tree-lined boulevards, cafés, and elegant holiday homes nearby.
            `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Explore Provence villas with live availability — from family-friendly farmhouses with pools to luxury estates set among vineyards. Updated daily from trusted partners for Summer 2026 and beyond.",
        },
    ],
}
