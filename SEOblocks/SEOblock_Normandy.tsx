...
SEOTextBlock.defaultProps = {
    h1: "Normandy Villas & Holiday Homes",
    intro: "Experience coastal France at its finest with Normandy villas and holiday homes — from D-Day beaches to countryside manors surrounded by apple orchards.",
    sections: [
        {
            title: "About Normandy",
            content:
                "Normandy blends rugged coastline with green countryside and rich history. Perfect for families, food lovers, and those seeking authentic French charm.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Honfleur</strong> – A picturesque harbour town with colourful façades and seafood restaurants.<br/><br/>
        <strong>Deauville</strong> – Chic seaside resort known for its promenade and film festival.<br/><br/>
        <strong>Bayeux</strong> – Famous for its medieval tapestry and proximity to the D-Day beaches.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Discover Normandy villas with live availability — from coastal cottages to grand country homes, updated daily for upcoming stays.",
        },
    ],
}
