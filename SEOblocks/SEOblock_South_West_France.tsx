...
SEOTextBlock.defaultProps = {
    h1: "South West France Villas & Holiday Homes",
    intro: "Discover the laid-back charm of South West France with our collection of villas — from Dordogne farmhouses to Atlantic coast escapes.",
    sections: [
        {
            title: "About South West France",
            content:
                "This diverse region offers everything from Bordeaux’s vineyards to the rolling hills of Gascony. Expect exceptional food, welcoming locals, and beautiful countryside.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Dordogne</strong> – Medieval villages, rivers, and stone farmhouses with pools.<br/><br/>
        <strong>Aquitaine</strong> – Atlantic surf beaches and charming wine country near Bordeaux.<br/><br/>
        <strong>Pyrenees</strong> – Mountain scenery, hiking, and rustic retreats on the Spanish border.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Explore South West France villas with live availability — from family cottages to luxury estates, updated daily for Summer 2026 and beyond.",
        },
    ],
}
