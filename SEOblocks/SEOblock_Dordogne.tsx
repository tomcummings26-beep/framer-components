...
SEOTextBlock.defaultProps = {
    h1: "Dordogne Villas & Holiday Homes",
    intro: "Escape to the heart of rural France with our Dordogne villas and holiday homes — perfect for families and countryside getaways.",
    sections: [
        {
            title: "About Dordogne",
            content:
                "The Dordogne offers rolling hills, rivers, and medieval villages — a picture-perfect region for food, wine, and relaxation.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Sarlat-la-Canéda</strong> – Beautiful stone architecture and lively markets.<br/><br/>
        <strong>Bergerac</strong> – Vineyards, river walks, and local charm.<br/><br/>
        <strong>Domme</strong> – Hilltop views over the Dordogne valley.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Browse Dordogne villas with live availability — from stone farmhouses to luxury countryside retreats.",
        },
    ],
}
