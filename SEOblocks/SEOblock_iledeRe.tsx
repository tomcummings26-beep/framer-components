...
// 🏝 Default content — Île de Ré
SEOTextBlock.defaultProps = {
    h1: "Île de Ré Villas & Holiday Homes",
    intro: "Embrace effortless island living on Île de Ré — whitewashed villages, sandy lanes, and chic harbours. Browse our curated villas and holiday homes with live availability.",
    sections: [
        {
            title: "About Île de Ré",
            content:
                "Linked to La Rochelle by a sweeping bridge, Île de Ré is a sun-kissed island of salt marshes, wide beaches, and picture-perfect villages. Days revolve around markets, cycling, and waterfront dinners — ideal for stylish yet relaxed family holidays.",
        },
        {
            title: "Top Villages",
            content: `
        <strong>Saint-Martin-de-Ré</strong> – UNESCO ramparts, harbour cafés, and boutique shops.<br/><br/>
        <strong>Ars-en-Ré</strong> – Iconic black-and-white church spire and quiet beaches nearby.<br/><br/>
        <strong>La Flotte</strong> – Stone quays, daily market, and charming backstreets.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Find Île de Ré villas with live availability — courtyard houses with shutters, family homes near the beach, and elegant garden villas. Updated daily for Summer 2026 and beyond.",
        },
    ],
}
