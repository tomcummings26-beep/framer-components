...
// 🏖 Default content — French Riviera example
SEOTextBlock.defaultProps = {
    h1: "French Riviera Villas & Holiday Homes",
    intro: "Experience the glamour of the Côte d’Azur with our curated collection of French Riviera villas — from chic sea-view homes in Nice to elegant retreats in Saint-Tropez and Cannes.",
    sections: [
        {
            title: "About the French Riviera",
            content:
                "The French Riviera — or Côte d’Azur — is world-famous for its sunshine, sophistication, and style. Stretching from Monaco to Saint-Tropez, this region offers turquoise beaches, hillside villages, and Michelin-starred dining. Whether you’re planning a romantic escape or a family getaway, the Riviera combines timeless beauty with modern luxury.",
        },
        {
            title: "Top Destinations",
            content: `
                <strong>Nice</strong> – Elegant seafront promenades, boutique shopping, and contemporary art in one of France’s most iconic coastal cities.<br/><br/>
                <strong>Cannes</strong> – Famous for its film festival, Cannes combines glamour with authentic French charm — from luxury villas to quiet coves nearby.<br/><br/>
                <strong>Saint-Tropez</strong> – Discover laid-back luxury and vibrant nightlife in Saint-Tropez, home to some of the Riviera’s finest private villas.
            `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Browse French Riviera villas with live availability — from family-friendly coastal properties to private estates with pools and sea views. Updated daily from trusted partners for Summer 2026 and beyond.",
        },
    ],
}
