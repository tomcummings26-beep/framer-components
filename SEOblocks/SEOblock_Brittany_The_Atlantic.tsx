...
SEOTextBlock.defaultProps = {
    h1: "Brittany & Atlantic Coast Villas & Holiday Homes",
    intro: "Explore Brittany and the Atlantic coast with our hand-picked villas — from seaside cottages to elegant retreats near La Rochelle and Île de Ré.",
    sections: [
        {
            title: "About Brittany & The Atlantic Coast",
            content:
                "This region combines dramatic coastline, family-friendly beaches, and vibrant harbour towns. Expect great seafood, sailing, and traditional Breton charm.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Brittany</strong> – Rugged cliffs, sandy bays, and charming fishing villages.<br/><br/>
        <strong>Atlantic Coast</strong> – Surf, seafood, and sun along France’s western shoreline.<br/><br/>
        <strong>Île de Ré</strong> – Chic island life with bike paths, markets, and harbour cafés.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Discover Brittany and Atlantic Coast villas with live availability — from coastal family homes to luxury seaside estates.",
        },
    ],
}
