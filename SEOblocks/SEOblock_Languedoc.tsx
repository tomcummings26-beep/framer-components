...
SEOTextBlock.defaultProps = {
    h1: "Languedoc Villas & Holiday Homes",
    intro: "Explore the unspoilt charm of Languedoc with our collection of villas and holiday homes — from medieval towns to tranquil countryside retreats near the Mediterranean coast.",
    sections: [
        {
            title: "About Languedoc",
            content:
                "Languedoc is one of southern France’s hidden gems — a region of vineyards, mountains, and sandy beaches stretching from the Pyrenees to the Camargue. It’s perfect for families and travellers seeking authenticity and space.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Carcassonne</strong> – A UNESCO fortress city with cobbled streets and spectacular views.<br/><br/>
        <strong>Montpellier</strong> – A lively cultural hub close to Mediterranean beaches.<br/><br/>
        <strong>Béziers</strong> – Vineyards, canal walks, and easy access to the coast.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Browse Languedoc villas with live availability — from countryside mas to beachside family homes, updated daily from trusted partners.",
        },
    ],
}
