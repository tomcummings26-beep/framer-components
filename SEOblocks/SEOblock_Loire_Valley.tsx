...
SEOTextBlock.defaultProps = {
    h1: "Loire Valley Villas & Holiday Homes",
    intro: "Discover the elegance of the Loire Valley with our curated villas and holiday homes — near the region’s grand châteaux, gardens, and vineyards.",
    sections: [
        {
            title: "About the Loire Valley",
            content:
                "Known as the Garden of France, the Loire Valley is a UNESCO World Heritage Site of castles, rivers, and vineyards. It offers relaxation, culture, and scenic beauty in equal measure.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Amboise</strong> – Riverside town famous for its château and Leonardo da Vinci’s home.<br/><br/>
        <strong>Saumur</strong> – Elegant architecture and sparkling wine cellars along the Loire.<br/><br/>
        <strong>Blois</strong> – A lively town with a royal château and cobbled streets.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Browse Loire Valley villas with live availability — from countryside farmhouses to châteaux near the river, updated daily for Summer 2026.",
        },
    ],
}
