...
// 🏖 Default content — South of France example
SEOTextBlock.defaultProps = {
    h1: "South of France Villas & Holiday Homes",
    intro: "Discover the timeless beauty of the South of France — a region that blends Mediterranean sunshine, lavender-scented hills, and world-class cuisine. From coastal retreats on the French Riviera to peaceful countryside escapes in Provence and Languedoc, our villas offer the perfect base for every kind of getaway.",
    sections: [
        {
            title: "About the South of France",
            content:
                "The South of France has long been a favourite for travellers seeking art, culture, and relaxation. Stretching from the glamorous Côte d’Azur to the wild charm of Languedoc and the rolling vineyards of Provence, it offers everything from beachside villas to hilltop châteaux. Expect sun-drenched markets, vineyards, and Mediterranean living at its finest.",
        },
        {
            title: "Top Destinations",
            content: `
                <strong>Provence</strong> – Endless lavender fields, picturesque villages, and traditional mas-style villas surrounded by olive groves.<br/><br/>
                <strong>French Riviera (Côte d’Azur)</strong> – Iconic coastal resorts including Cannes, Nice, and Saint-Tropez, famous for luxury, beaches, and sea views.<br/><br/>
                <strong>Languedoc</strong> – A laid-back region of vineyards, historic towns, and family-friendly coastal escapes.
            `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Explore South of France villas with live availability — from romantic Provence hideaways to spacious family estates with pools. Updated daily with the latest prices and offers for 2026 and beyond.",
        },
    ],
}
