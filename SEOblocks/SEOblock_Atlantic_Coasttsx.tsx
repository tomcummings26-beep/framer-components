...
// 🌊 Default content — Atlantic Coast
SEOTextBlock.defaultProps = {
    h1: "Atlantic Coast Villas & Holiday Homes",
    intro: "Discover France’s Atlantic Coast with our curated villas and holiday homes — from chic harbour towns to long sandy beaches perfect for family holidays and surf escapes.",
    sections: [
        {
            title: "About the Atlantic Coast",
            content:
                "Stretching from La Rochelle to Biarritz, France’s Atlantic Coast blends big skies, seafood markets, pine forests, and golden beaches. Expect relaxed seaside living, bike paths through dunes, and charming coastal towns with lively summer ambience.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>La Rochelle</strong> – Historic harbour, island ferries, and vibrant markets.<br/><br/>
        <strong>Île d’Oléron</strong> – Wild beaches, oyster huts, and miles of cycling trails.<br/><br/>
        <strong>Royan &amp; Côte de Beauté</strong> – Family-friendly bays and Belle Époque villas.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Explore Atlantic Coast villas with live availability — from beachside family homes to contemporary retreats near dunes and pine forests. Updated daily from trusted partners.",
        },
    ],
}
