...
SEOTextBlock.defaultProps = {
    h1: "Burgundy Villas & Holiday Homes",
    intro: "Stay amid rolling vineyards and medieval villages with our selection of Burgundy villas and holiday homes — perfect for wine lovers and countryside explorers.",
    sections: [
        {
            title: "About Burgundy",
            content:
                "Burgundy is renowned for world-class wines, quiet canals, and elegant châteaux. It’s a destination of timeless rural beauty and authentic French living.",
        },
        {
            title: "Top Destinations",
            content: `
        <strong>Beaune</strong> – The wine capital of Burgundy, home to the historic Hospices de Beaune.<br/><br/>
        <strong>Dijon</strong> – A vibrant city rich in history, gastronomy, and mustard heritage.<br/><br/>
        <strong>Chablis</strong> – Tranquil vineyards producing some of France’s finest white wines.
      `,
        },
        {
            title: "Browse Available Villas",
            content:
                "Explore Burgundy villas with live availability — from vineyard cottages to châteaux, updated daily from trusted partners.",
        },
    ],
}
