...
const OT_LOGO =
    "https://raw.githubusercontent.com/tomcummings26-beep/villa-api/main/Oliver's%20Travels%20Logo.png"
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    you book with Oliver’s Travels.
                                </p>
...
export default function VillaDetailDynamic({ fallbackVillaId = 457 }: Props) {
    ...
    useEffect(() => {
        ...
        fetch(`${API_BASE}/villas`)
            .then((res) => res.json())
            .then((data: Villa[]) => {
                const match = data.find((v) => v.villa_id === villaId)
                setVilla(match || null)
    ...
    const oliverUrl =
        selectedStartDate && selectedEndDate
            ? `${villa.url}?start_date=${selectedStartDate}&end_date=${selectedEndDate}&search_type=fixed`
            : villa.url
            ...
            <div style={{ padding: isMobile ? "16px" : "18px 18px 16px" }}>
                ...
                <div style={{ marginBottom: "14px" }}>
                    ...
                    >
                        {selectedPrice?.price != null
                            ? `£${Math.round(selectedPrice.price).toLocaleString()}`
                            : "—"}
                    </div>
                    ...
                    >
                        {selectedStartDate && selectedEndDate
                            ? `${selectedNights} nights • ${villa.capacity} guests`
                ...
                >
                    ...
                    >
                        ...
                        >
                            Book via our trusted partner
                        </span>

                        <img
                            src={OT_LOGO}
                            alt="Oliver's Travels"
                            style={{
                    ...
                    >
                        You’ll complete your booking securely on Oliver’s
                        Travels
                    </div>
                </div>
                ...
                >
                    Final booking price is confirmed on Oliver’s Travels.
                </p>
            </div>
        </div>
    )
            ...
            >
                <div style={{ minWidth: 0 }}>
                    ...
                    >
                        ...
                        <p style={bodyTextStyle}>
                            Ask us a question about this villa and we can help
                            with suitability, layout or location before you
                        ...
                        >
                            ...
                            >
                                Ready to book on Oliver’s Travels →
                            </a>
                        </div>
                    </section>
